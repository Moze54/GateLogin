    ...
    <div class="tech-wrapper">
        ...
        <div class="tech-login-area">
            ...
            <div class="card-header">
                ...
                <h1 class="site-title"><?php echo $isRegister ? 'REGISTRATION' : 'ACCESS CONTROL'; ?></h1>
                <p class="site-subtitle"><?php echo $isRegister ? '账号注册系统' : '身份验证系统'; ?></p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loginForm.addEventListener('submit', function(e) {
        ...
        submitBtn.querySelector('.button-text').textContent = originalText === 'LOGIN' ? '登录中...' : '注册中...';
    });
